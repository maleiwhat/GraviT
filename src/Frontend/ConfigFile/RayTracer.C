...
void RayTracer::RenderImage(string imagename = "mpitrace") {
  ...
  switch (GVT::Env::RayTracerAttributes::rta->schedule) {
    case GVT::Env::RayTracerAttributes::Image:
      GVT::Trace::Tracer<MPICOMM, ImageSchedule>(rays, image)();
      break;
    case GVT::Env::RayTracerAttributes::Domain:
      GVT::Trace::Tracer<MPICOMM, DomainSchedule>(rays, image)();
      break;
    case GVT::Env::RayTracerAttributes::Greedy:
      GVT::Trace::Tracer<MPICOMM, HybridSchedule<GreedySchedule> >(rays,
                                                                   image)();
      break;
    case GVT::Env::RayTracerAttributes::Spread:
      GVT::Trace::Tracer<MPICOMM, HybridSchedule<SpreadSchedule> >(rays,
                                                                   image)();
      break;
    case GVT::Env::RayTracerAttributes::RayWeightedSpread:
      GVT::Trace::Tracer<MPICOMM, HybridSchedule<RayWeightedSpreadSchedule> >(
          rays, image)();
      break;
    case GVT::Env::RayTracerAttributes::AdaptiveSend:
      GVT::Trace::Tracer<MPICOMM, HybridSchedule<AdaptiveSendSchedule> >(
          rays, image)();
      break;
    case GVT::Env::RayTracerAttributes::LoadOnce:
      GVT::Trace::Tracer<MPICOMM, HybridSchedule<LoadOnceSchedule> >(rays,
                                                                     image)();
      break;
      GVT::Trace::Tracer<MPICOMM, HybridSchedule<LoadAnyOnceSchedule> >(
          rays, image)();
      break;
    case GVT::Env::RayTracerAttributes::LoadAnother:
      GVT::Trace::Tracer<MPICOMM, HybridSchedule<LoadAnotherSchedule> >(
          rays, image)();
      break;
    case GVT::Env::RayTracerAttributes::LoadMany:
      GVT::Trace::Tracer<MPICOMM, HybridSchedule<LoadManySchedule> >(rays,
                                                                     image)();
      break;
    default:
