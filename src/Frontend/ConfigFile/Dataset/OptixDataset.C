...
//        template<>
//        GVT::Domain::Domain*
//        Dataset<GVT::Domain::OptixDomain>::getDomain(int id) {
//            if (id < 0 || id >= files.size()) {
//                cerr << "ERROR: invalid domain id '" << id << "' passed to GetDomain" << endl;
//                return NULL;
//            }
//            cout << "Get domain " << files[id] << endl;
//            map< int, GVT::Domain::OptixDomain >::iterator it = dom_cache.find(id);
//            if (it != dom_cache.end()) {
//                cout << "In cache " << files[id] << endl;
//                return &(it->second);
//            }
//            dom_cache[id] = GVT::Domain::OptixDomain(files[id], dom_model[id]);
