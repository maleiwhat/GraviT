...
class AmbientLightSource : public LightSource {
 public:
  AmbientLightSource(const GVT::Math::Vector4f color =
                         GVT::Math::Vector4f(1.f, 1.f, 1.f, 0.f));
  ...
  //            virtual GVT::Data::box3D getWorldBoundingBox() {
  //
  //                GVT::Data::box3D bb(GVT::Math::Point4f(),
  // GVT::Math::Point4f());
  //
  //                return bb;
  //            }
...
class PointLightSource : public LightSource {
 public:
  PointLightSource(const GVT::Math::Point4f position = GVT::Math::Point4f(),
