...
Domain::Domain(GVT::Math::AffineTransformMatrix<float> m)
...
void Domain::trace(GVT::Data::RayVector& rayList,
...
GVT::Data::box3D Domain::getWorldBoundingBox() { return getBounds(1); }

void Domain::setBoundingBox(GVT::Data::box3D bb) { boundingBox = bb; }
...
bool Domain::domainIsLoaded() { return isLoaded; }

int Domain::getDomainID() { return domainID; }

void Domain::setDomainID(int id) { domainID = id; }
}
}
