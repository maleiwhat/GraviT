...
IF(NOT EMBREE_SOURCE_PREFIX)
	SET(EMBREE_SOURCE_PREFIX $ENV{EMBREE_SOURCE_PREFIX})
ENDIF()

IF (EMBREE_INCLUDE_DIR)
  INCLUDE_DIRECTORIES(${EMBREE_INCLUDE_DIR})
ELSE (EMBREE_INCLUDE_DIR)
  message(FATAL_ERROR " Set EMBREE_INCLUDE_DIR")
ENDIF()
...
IF (EMBREE_BUILD_PREFIX)
  ...
  SET(EMBREE_TARGET_LINK_LIBRARIES embree)

  SET(EMBREE_LINK_DIRECTORIES ${EMBREE_BUILD_PREFIX} ${EMBREE_LINK_DIRECTORIES})
  ...
  LINK_DIRECTORIES(${EMBREE_LINK_DIRECTORIES})
