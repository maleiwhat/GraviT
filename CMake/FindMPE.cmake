...
find_program(MPE_CLOG2SLOG
  NAMES clogTOslog2 PATHS $ENV{MPE_INSTALL_DIR}/build/bin
...
elseif (MPE_CLOG2SLOG)
  exec_program(${MPE_CLOG2SLOG}
    ARGS -show -mpilog
    OUTPUT_VARIABLE MPE_COMPILE_CMDLINE
    RETURN_VALUE MPE_COMPILE_RETURN
    )
  if (NOT MPE_COMPILE_RETURN EQUAL 0)
    message(STATUS, "Unable to determine MPE from MPE driver ${MPE_CLOG2SLOG}")
...
if (DEFINED ENV{MPEHOME})
   ...
   if (MPE_LIBRARIES)
      ...
      FIND_LIBRARY(MPE_LIBRARIES NAME mpe PATHS ${MPE_HOME_DIR} PATH_SUFFIXES lib )
   endif(MPE_LIBRARIES)
endif()
